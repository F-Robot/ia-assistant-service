...
export interface ApiContextFileContextFile extends Struct.CollectionTypeSchema {
  collectionName: 'context_files'
  info: {
    displayName: 'ContextFile'
    pluralName: 'context-files'
    singularName: 'context-file'
  }
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::context-file.context-file'> & Schema.Attribute.Private
    publishedAt: Schema.Attribute.DateTime
    text: Schema.Attribute.Text
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    vectorStoreId: Schema.Attribute.Text
  }
}

export interface ApiContextContext extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    contextFileId: Schema.Attribute.Text
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    description: Schema.Attribute.Text
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::context.context'> & Schema.Attribute.Private
    publishedAt: Schema.Attribute.DateTime
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::context-file.context-file': ApiContextFileContextFile
      'api::context.context': ApiContextContext
